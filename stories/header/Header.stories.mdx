...
The header comes in white or navy. Use the `header--white` and `header--navy`
classes.
...
The header can contain navigation items. These can either be simple links:

<Story story={stories.withNavItems} />

Or they can be dropdown menus for more complex navigation:
